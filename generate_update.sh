...
linux="$(curl https://github.com/vivax3794/supercharged-stars/releases/download/v${1}/supercharged-stars_0.1.10_amd64.AppImage.tar.gz.sig -L)"
windows="$(curl https://github.com/vivax3794/supercharged-stars/releases/download/v${1}/supercharged-stars_0.1.10_x64_en-US.msi.zip.sig -L)"
